...
function NNVisualizer() {
    ...
    return (
    <>
        <NNGraph x={x} w1={weightOne} b1={biasOne} w2={weightTwo} b2={biasTwo} y={y}></NNGraph>
        <div class="container">
            <div class="row">
                <div className='col-md-12 mt-5'>
                    ...
                    b2: <input type="text" value={biasTwo} onChange={(event) => setBiasTwo(event.target.value)}></input><br></br>
                    y(true value): <input type="text" value={y} onChange={(event) => setY(event.target.value)}></input>
                </div>
            </div>
        </div>
    </>
